...
export const addLiquidity = async (signer, addCDAmountWei, addEtherAmountWei) => {
   try {
      ...
      // since CD tokens are ERC20 token, before adding to the liquidity pool we will need approval 
      ...
      console.log("Approval given for fund transfer ")
      console.log("Starting fund trasfer")
